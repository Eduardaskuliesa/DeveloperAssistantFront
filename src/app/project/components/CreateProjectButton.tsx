  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger className="" asChild>
        <button className="flex h-9 mt-2  px-2 hover:scale-[1.02] items-center rounded-md w-full overflow-hidden cursor-pointer border-neutral-700 text-neutral-400 font-semibold text-sm hover:bg-theme-gray  transition-colors">
